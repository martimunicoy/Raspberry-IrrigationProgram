...
class Schedule(object):
            ...
            for line in f:
                ...
                if line.startswith('CYCLE'):
                    ...
                    for hour in hours:
                        ...
                        self.timetable.append(datetime.datetime.combine(
                            today_date, trigger_time))
    ...
    def log_info(self):
        ...
        for delay in self.next_timer():
                    ...
                    remaining = (datetime.datetime(1970, 1, 1) +
                                 datetime.timedelta(seconds=delay)).replace(
                                     microsecond=0)
                    sch_str += "\n    {}            {}".format(
                        hour.time(), remaining.time())
        cyc_str = ""
